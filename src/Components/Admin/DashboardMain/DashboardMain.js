    ...
    <>
      <article className={currentTheme}>
        ...
        <Drawer variant="permanent" className='drawer' open={open}>
          ...
          <Divider />
          <List >
            {['Panel', "Blogs", "Projects", ].map((text, index) => (
              <ListItemButton as={NavLink} to={index === 0 ? "" : `${text.toLowerCase().split(' ').join('-')}`}
                key={text}
                sx={{
                  minHeight: 48,
              ...
              >
                ...
                >
                  {[<OtherHousesOutlinedIcon />, <DataSaverOnOutlinedIcon />, <TerminalOutlinedIcon />, <WorkspacePremiumIcon />, <MailIcon />][index] }
                </ListItemIcon>
          ...
          {!state.email ? <List>
              <ListItemButton as={Link} to="authentication"
                sx={{
                  minHeight: 48,
                  justifyContent: open ? 'initial' : 'center',
                  px: 2.5,
              ...
              >
                ...
                <ListItemText primary="Authorize" sx={{ opacity: open ? 1 : 0 }} />
              </ListItemButton>
          </List> : 
          <List>
